...
@Table(name = "tbl_record_empowerment_balance")
public class RecordEmpowermentBalance {
    /**
     * 主键
     */
    @Id
    ...
    /**
     * 获取（积分类型）consumption:消费 exchange:兑换，shiyi:屹家无忧
     *
     * @return bean_type - （积分类型）consumption:消费 exchange:兑换，shiyi:屹家无忧
     */
    ...
    /**
     * 设置（积分类型）consumption:消费 exchange:兑换，shiyi:屹家无忧
     *
     * @param beanType （积分类型）consumption:消费 exchange:兑换，shiyi:屹家无忧
     */
