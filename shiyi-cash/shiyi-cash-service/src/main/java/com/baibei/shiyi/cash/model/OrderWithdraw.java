...
public class OrderWithdraw {
     ...
     * 请求福清参数
     */
    @Column(name = "fuqing_withdraw_req")
    private String fuqingWithdrawReq;

    /**
     * 福清返回结果报文
     */
    @Column(name = "fuqing_withdraw_resp")
    private String fuqingWithdrawResp;
    ...
    public String getFuqingWithdrawReq() {
        return fuqingWithdrawReq;
    }

    public void setFuqingWithdrawReq(String fuqingWithdrawReq) {
        this.fuqingWithdrawReq = fuqingWithdrawReq;
    }

    public String getFuqingWithdrawResp() {
        return fuqingWithdrawResp;
    }

    public void setFuqingWithdrawResp(String fuqingWithdrawResp) {
        this.fuqingWithdrawResp = fuqingWithdrawResp;
    }
}