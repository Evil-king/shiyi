...
public class CommonParamCheckFilter extends ZuulFilter {
    ...
    public Object run() throws ZuulException {
        ...
        try {
           ...
           ctx.set("client",jsonRequest.getPlatform());
           ctx.set("version",jsonRequest.getVersion());
           ctx.set("channelCode",jsonRequest.getChannelCode());
            ctx.set("ip",ip);
            // 设置请求上下文
    ...
    private ApiResult<String> checkEmptyParam(JsonRequest jsonRequest) {
        ...
        if (!Constants.Platform.Android.equals(platform) && !Constants.Platform.IOS.equals(platform) && !Constants.Platform.PC.equals(platform)&& !Constants.Platform.H5.equals(platform)) {
