...
public class SignUtil {
    public static void main(String[] args) {
        ...
        jsonRequest.setAccessToken("cd285f0402fd4fbb831fcef4294e2229");
        jsonRequest.setAppKey("003ac33df93bp");
        jsonRequest.setDeviceId("abcedfg");
        jsonRequest.setPlatform("IOS");
        jsonRequest.setSign("123");
        jsonRequest.setTimestamp(System.currentTimeMillis() + "");
        jsonRequest.setVersion("V1.0");

        // 设置data业务参数
        Map<String, Object> data = new HashMap<>();
        data.put("userNo", "2019042113342627");
        ...
        String uri = "/auth/api/user/userInfo/getUserInfo";
