...
public class FTPUtils {
    ...
    public FTPUtils(String ftpHost, int ftpPort, String ftpName, String ftpPwd, String controlEncoding, String remotePath) {
    ...
    public Boolean uploadFile(File file) {
        ...
        // stop 文件上传
        return uploadFile(ftpClient, file);
    }
    ...
    public Boolean downLoadFile(File file) {
        FTPClient ftpClient = this.initFtp();
        return downloadFile(ftpClient, file);
    }
