 ...
 * @author 林英男
 */
public class BankMessageAnalysisUtils {
    /**
     * 解析返回报文
     ...
     * @return
     */
    public static Map<String, String>  parsingTranMessageString(String TranMessage) {
     ...
     * @param retKeyDict
     */
    public static void spiltMessage(Map retKeyDict) {
    ...
    public static void spiltMessage_1303(Map<String, String> retKeyDict) {
    ...
    public static void spiltMessage_1310(Map<String, String> retKeyDict) {
    ...
    public static void spiltMessage_1318(Map<String, String> retKeyDict) {
        String backBodyMessage = retKeyDict.get("backBodyMessages");
        String[] bodyMessages = backBodyMessage.split("&", -1);
    ...
    public static void spiltMessage_1317(Map<String, String> retKeyDict) {
        String backBodyMessage = retKeyDict.get("backBodyMessages");
        String[] bodyMessages = backBodyMessage.split("&", -1);
        retKeyDict.put("FrontLogNo", bodyMessages[0]);
        retKeyDict.put("HandFee", bodyMessages[1]);
    ...
    public static void spiltMessage_1002(Map<String, String> retKeyDict) {
        String backBodyMessage = retKeyDict.get("backBodyMessages");
        String[] bodyMessages = backBodyMessage.split("&", -1);
    ...
    public static void spiltMessage_1003(Map<String, String> retKeyDict) {
        String backBodyMessage = retKeyDict.get("backBodyMessages");
        String[] bodyMessages = backBodyMessage.split("&", -1);
        retKeyDict.put("FrontLogNo", bodyMessages[0]);
        retKeyDict.put("Reserve", bodyMessages[1]);
    ...
    public static void spiltMessage_1004(Map<String, String> retKeyDict) {
        String backBodyMessage = retKeyDict.get("backBodyMessages");
        String[] bodyMessages = backBodyMessage.split("&", -1);
    ...
    public static void spiltMessage_1005(Map<String, String> retKeyDict) {
        String backBodyMessage = (String) retKeyDict.get("backBodyMessages");
        String[] bodyMessages = backBodyMessage.split("&", -1);
        retKeyDict.put("FuncFlag", bodyMessages[0]);
        retKeyDict.put("SupAcctId", bodyMessages[1]);
    ...
    public static void spiltMessage_1006(Map<String, String> retKeyDict) {
        String backBodyMessage = (String) retKeyDict.get("backBodyMessages");
        String[] bodyMessages = backBodyMessage.split("&", -1);
        retKeyDict.put("FileName", bodyMessages[0]);
        retKeyDict.put("Reserve", bodyMessages[1]);
    ...
    public static void spiltMessage_1010(Map<String, String> retKeyDict) {
        String backBodyMessage = (String) retKeyDict.get("backBodyMessages");
        String[] bodyMessages = backBodyMessage.split("&", -1);
    ...
    public static void spiltMessage_1022(Map<String, String> retKeyDict) {
        String backBodyMessage = (String) retKeyDict.get("backBodyMessages");
        String[] bodyMessages = backBodyMessage.split("&", -1);
    ...
    public static void spiltMessage_1016(Map<String, String> retKeyDict) {
        String backBodyMessage = (String) retKeyDict.get("backBodyMessages");
        String[] bodyMessages = backBodyMessage.split("&", -1);
        retKeyDict.put("TotalCount", bodyMessages[0]);
        retKeyDict.put("BeginNum", bodyMessages[1]);
    ...
    public static void spiltMessage_1019(Map<String, String> retKeyDict) {
        String backBodyMessage = (String) retKeyDict.get("backBodyMessages");
        String[] bodyMessages = backBodyMessage.split("&", -1);
        retKeyDict.put("SupAcctId", bodyMessages[0]);
    ...
    public static void spiltMessage_1325(Map<String, String> retKeyDict) {
        String backBodyMessage = (String) retKeyDict.get("backBodyMessages");
        String[] bodyMessages = backBodyMessage.split("&", -1);
        retKeyDict.put("TotalCount", bodyMessages[0]);
        retKeyDict.put("BeginNum", bodyMessages[1]);
    ...
    public static void spiltMessage_1324(Map<String, String> retKeyDict) {
        String backBodyMessage = (String) retKeyDict.get("backBodyMessages");
        String[] bodyMessages = backBodyMessage.split("&", -1);
        retKeyDict.put("TotalCount", bodyMessages[0]);
        retKeyDict.put("BeginNum", bodyMessages[1]);
    ...
    public static void spiltMessage_1330(Map<String, String> retKeyDict) {
        String backBodyMessage = (String) retKeyDict.get("backBodyMessages");
        String[] bodyMessages = backBodyMessage.split("&", -1);
        retKeyDict.put("FrontLogNo", bodyMessages[0]);
        retKeyDict.put("Reserve", bodyMessages[1]);
    ...
    public static void spiltMessage_1332(Map<String, String> retKeyDict) {
        String backBodyMessage = (String) retKeyDict.get("backBodyMessages");
        String[] bodyMessages = backBodyMessage.split("&", -1);
        retKeyDict.put("FrontLogNo", bodyMessages[0]);
        retKeyDict.put("Reserve", bodyMessages[1]);
    ...
    public static void spiltMessage_1028(Map<String, String> retKeyDict) {
        String backBodyMessage = (String) retKeyDict.get("backBodyMessages");
        String[] bodyMessages = backBodyMessage.split("&", -1);
        retKeyDict.put("FrontLogNo", bodyMessages[0]);
    ...
    public static void spiltMessage_1029(Map<String, String> retKeyDict) {
        String backBodyMessage = (String) retKeyDict.get("backBodyMessages");
        String[] bodyMessages = backBodyMessage.split("&", -1);
        retKeyDict.put("FrontLogNo", bodyMessages[0]);
        retKeyDict.put("Reserve", bodyMessages[1]);
    ...
    public static void spiltMessage_1030(Map<String, String> retKeyDict) {
        String backBodyMessage = (String) retKeyDict.get("backBodyMessages");
        String[] bodyMessages = backBodyMessage.split("&", -1);
        retKeyDict.put("FrontLogNo", bodyMessages[0]);
        retKeyDict.put("Reserve", bodyMessages[1]);
    ...
    public static void spiltMessage_1031(Map<String, String> retKeyDict) {
        String backBodyMessage = (String) retKeyDict.get("backBodyMessages");
        String[] bodyMessages = backBodyMessage.split("&", -1);
        retKeyDict.put("FrontLogNo", bodyMessages[0]);
        retKeyDict.put("Reserve", bodyMessages[1]);
    ...
    public static void spiltMessage_1351(Map<String, String> retKeyDict) {
        String backBodyMessage = (String) retKeyDict.get("backBodyMessages");
        String[] bodyMessages = backBodyMessage.split("&", -1);
        retKeyDict.put("TotalCount", bodyMessages[0]);
        retKeyDict.put("BeginNum", bodyMessages[1]);
    ...
    public static void spiltMessage_1352(Map<String, String> retKeyDict) {
        String backBodyMessage = (String) retKeyDict.get("backBodyMessages");
        String[] bodyMessages = backBodyMessage.split("&", -1);
    ...
    private static void spiltMessage_1312(Map retKeyDict) {
        String backBodyMessage = (String) retKeyDict.get("backBodyMessages");
        String[] bodyMessages = backBodyMessage.split("&", -1);
    ...
    public static void main(String[] args) {
        Map<String, String> stringStringMap = parsingTranMessageString("A0010301019157                0000000161000000PA001022019111117210620191111153926941667ERR020无符合条件记录                                                                                      00000             00000000000132502                20191111172106ERR020无符合条件记录                            000000039PA001201911111539269416679157&&&0&20191111153926941667&&&&0.00&&&&&&");
