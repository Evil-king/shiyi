...
public class BankMessageSpliceUtils {
     ...
     * @author 林英男
     */
    public static String getYinShangJieSuanTongHeadMessage(int bodyLength, Map<String, String> parmaKeyDict) {
     ...
     * @return
     */
    public static String getSignMessage(Map parmaKeyDict) {
    ...
    private static String getSignMessageBody_1318(HashMap parmaKeyDict) {
    ...
    private static String getSignMessageBody_1312(HashMap parmaKeyDict) {
    ...
    private static String getSignMessageBody_1325(HashMap parmaKeyDict) {
        String SupAcctId = "";// 资金汇总账号
    ...
    private static String getSignMessageBody_1317(HashMap parmaKeyDict) {
     ...
     * @return
     */
    public static String returnMsg(String msg, Integer countLength) {
    ...
    public static String getSignMessageBody_1303(Map<String, String> parmaKeyDict) {
        String ThirdLogNo = "";//
        String Reserve = "";//
    ...
    public static String getSignMessageBody_1310(Map<String, String> parmaKeyDict) {
        String ThirdLogNo = "";//
        String Reserve = "";//
    ...
    public static String getSignMessageBody_1312(Map<String, String> parmaKeyDict) {
        String ThirdLogNo = "";//
        String Reserve = "";//
    ...
    public static String getSignMessageBody_1318(Map<String, String> parmaKeyDict) {
        String TranWebName = "";//
        String ThirdCustId = "";//
        String IdType = "";//
        String IdCode = "";//
    ...
    public static String getSignMessageBody_1317(Map<String, String> parmaKeyDict) {
        String FrontLogNo = "";//
        String TranWebName = "";//
        String ThirdCustId = "";//
        String IdType = "";//
    ...
    public static String getSignMessageBody_1003(Map<String, String> parmaKeyDict) {
        String FuncFlag = "";//
        String FileName = "";//
        String FileSize = "";//
        String SupAcctId = "";//
    ...
    public static String getSignMessageBody_1004(Map<String, String> parmaKeyDict) {
        String FuncFlag = "";//
        String BeginDate = "";//
        String EndDate = "";//
        String SupAcctId = "";//
    ...
    public static String getSignMessageBody_1005(Map<String, String> parmaKeyDict) {
        String Reserve = "";//
    ...
    public static String getSignMessageBody_1006(Map<String, String> parmaKeyDict) {
        String FuncFlag = "";//
        String SupAcctId = "";//
    ...
    public static String getSignMessageBody_1010(Map<String, String> parmaKeyDict) {
        String SupAcctId = "";//
        String ThirdCustId = "";//
        String CustAcctId = "";//
        String SelectFlag = "";//
    ...
    public static String getSignMessageBody_1022(Map<String, String> parmaKeyDict) {
        String AcctId = "";
        String TranWebCode = "";
        String Reserve = "";
    ...
    public static String getSignMessageBody_1012(Map<String, String> parmaKeyDict) {
        String CustAcctId = "";//
        String SelectFlag = "";//
        String PageNum = "";
        String Reserve = "";
    ...
    public static String getSignMessageBody_1016(Map<String, String> parmaKeyDict) {
        String SupAcctId = "";//
        String BeginDate = "";//
        String EndDate = "";//
        String PageNum = "";//
    ...
    public static String getSignMessageBody_1019(Map<String, String> parmaKeyDict) {
        String CustAcctId = "";//
        String ThirdCustId = "";//
        String CustName = "";//
        String TotalAmount = "";//
    ...
    public static String getSignMessageBody_1325(Map<String, String> parmaKeyDict) {
        String SupAcctId = "";//
    ...
    public static String getSignMessageBody_1324(Map<String, String> parmaKeyDict) {
        String SupAcctId = "";//
        String OrigThirdLogNo = "";//
        String BeginDate = "";//
        String EndDate = "";//
    ...
    public static String getSignMessageBody_1330(Map<String, String> parmaKeyDict) {
        String FuncFlag = "";//
        String TxDate = "";//
        String Reserve = "";//
        if (parmaKeyDict.containsKey("FuncFlag")) {
    ...
    public static String getSignMessageBody_1332(Map<String, String> parmaKeyDict) {
        String SupAcctId = "";//
        String FuncFlag = "";//
    ...
    public static String getSignMessageBody_1028(Map<String, String> parmaKeyDict) {
        String SupAcctId = "";//
        String FuncFlag = "";//
        String OutCustAcctId = "";//
        String OutThirdCustId = "";//
    ...
    public static String getSignMessageBody_1029(Map<String, String> parmaKeyDict) {
        String SupAcctId = "";//
        String FuncFlag = "";//
        String CustAcctId = "";//
        String ThirdCustId = "";//
    ...
    public static String getSignMessageBody_1030(Map<String, String> parmaKeyDict) {
        String SupAcctId = "";//
        String FuncFlag = "";//
        String CustAcctId = "";//
        String ThirdCustId = "";//
    ...
    public static String getSignMessageBody_1031(Map<String, String> parmaKeyDict) {
        String SupAcctId = "";//
        String FuncFlag = "";//
        String CustAcctId = "";//
        String ThirdCustId = "";//
    ...
    public static String getSignMessageBody_1351(Map<String, String> parmaKeyDict) {
        String SupAcctId = "";//
        String CustAcctId = "";//
        String SelectFlag = "";//
        String BeginDate = "";//
    ...
    public static String getSignMessageBody_1352(Map<String, String> parmaKeyDict) {
        String SupAcctId = "";
        String MainAcctId = "";
        String ReceptNo = "";
        String Reserve = "";
