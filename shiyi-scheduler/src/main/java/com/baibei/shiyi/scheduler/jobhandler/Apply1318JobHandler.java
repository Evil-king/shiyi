 ...
 * @description:定时调用1318接口
 */
@JobHandler(value = "apply1318JobHandler")
@Component
public class Apply1318JobHandler extends IJobHandler {
    @Autowired
    ...
    public ReturnT<String> execute(String s) throws Exception {
        ...
        ApiResult apiResult = shiyiWithdrawFeign.applySchedule1318();
