package com.baibei.shiyi.common.core.mybatis;
...
public abstract class AbstractService<T> implements Service<T> {
    ...
    @Override
    public MyPageInfo<T> pageList(Condition condition, CustomerBaseAndPageDto customerBaseAndPageDto) {
        PageParam pageParam = new PageParam();
        pageParam.setCurrentPage(customerBaseAndPageDto.getCurrentPage());
        pageParam.setPageSize(customerBaseAndPageDto.getPageSize());
        pageParam.setSort(customerBaseAndPageDto.getSort());
        pageParam.setOrder(customerBaseAndPageDto.getOrder());
        return pageList(condition, pageParam);
    }
