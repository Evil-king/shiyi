package com.baibei.shiyi.pingan.utils;
 ...
 */
@Component
public class GetSentServerUtils {
    ...
    /**
     * @param socketModel 通讯地址实体类对象
     * @param tranMessage 请求报文
     * @author 林英男
     * @see 发送请求报文并接收返回
     */
    public String sendAndGetMessage(String tranMessage) {
