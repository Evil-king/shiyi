 ...
 */
public class CodeGenerator_JHQ {
    /**
     * JDBC配置
     */
    private static final String JDBC_URL = "jdbc:mysql://192.168.12.200:15529/shiyi-cash";
     ...
     * 项目路径相关
     */
    private static final String PROJECT_PATH = "F:/baibeiProject/shiyi-backend/shiyi-cash/shiyi-cash-service"; // 项目基础路径
    private static final String TEMPLATE_PATH = "F:/baibeiProject/shiyi-backend/shiyi-code-generator/src/main/resources/template"; // 代码模板路径
    public static final String BASE_PACKAGE = "com.baibei.shiyi.cash";//项目基础包名称，根据自己公司的项目修改
    ...
    private static final String AUTHOR = "uqing";//@author
