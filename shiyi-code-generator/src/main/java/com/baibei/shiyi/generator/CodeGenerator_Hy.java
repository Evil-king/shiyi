...
public class CodeGenerator_Hy {
     ...
     * 项目路径相关
     */
    private static final String PROJECT_PATH = "D:/baibei/code/shiyi-backend/shiyi-trade/shiyi-trade-service"; // 项目基础路径
    private static final String TEMPLATE_PATH = "D:/baibei/code/shiyi-backend/shiyi-code-generator/src/main/resources/template"; // 代码模板路径
    ...
    public static void main(String[] args) {
        //genCodeByCustomModelName("tbl_tra_product", "Product");
        genCodeByCustomModelName("tbl_tra_hold_details", "HoldDetails");
        genCodeByCustomModelName("tbl_tra_hold_record", "HoldRecord");
        //genCodeByCustomModelName("tbl_tra_hold_record", "HoldRecord");
        //genCodeByCustomModelName("tbl_tra_entrust_details_ref", "EntrustDetailsRef");
    }
