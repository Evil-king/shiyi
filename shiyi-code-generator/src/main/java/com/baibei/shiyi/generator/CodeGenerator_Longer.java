...
public class CodeGenerator_Longer {
     ...
     * 项目路径相关
     */
    private static final String PROJECT_PATH = "F:/shiyi-backend/shiyi-cash/shiyi-cash-service"; // 项目基础路径
    ...
    public static void main(String[] args) {
        genCodeByCustomModelName("tbl_set_bank_order", "BankOrder");
        genCodeByCustomModelName("tbl_set_withdraw_deposit_diff", "WithDrawDepositDiff");
    }
