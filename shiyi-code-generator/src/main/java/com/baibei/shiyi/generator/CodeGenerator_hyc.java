 ...
 */
public class CodeGenerator_hyc {
    /**
     * JDBC配置
     */
    private static final String JDBC_URL = "jdbc:mysql://192.168.12.200:15529/shiyi-admin";
     ...
     * 项目路径相关
     */
    private static final String PROJECT_PATH = "D:/shiyimall/shiyimall/shiyi-admin-web"; // 项目基础路径
    private static final String TEMPLATE_PATH = "D:/shiyimall/shiyimall/shiyi-code-generator/src/main/resources/template"; // 代码模板路径
//    private static final String PROJECT_PATH = "G:/IdeaProjects/shiyi-backend/shiyi-account/shiyi-account-service"; // 项目基础路径
//    private static final String TEMPLATE_PATH = "G:/IdeaProjects/shiyi-backend/shiyi-code-generator/src/main/resources/template"; // 代码模板路径
    public static final String BASE_PACKAGE = "com.baibei.shiyi.admin.modules.system";//项目基础包名称，根据自己公司的项目修改
    ...
    public static void main(String[] args) {
        genCodeByCustomModelName("tbl_agent_test", "AgentTest");
        genCodeByCustomModelName("tbl_org_test", "OrgTest");
//        genCodeByCustomModelName("tbl_customer_bean", "CustomerBean");
